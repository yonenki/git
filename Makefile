...
TEST_BUILTINS_OBJS += test-textil-ext-executor-server.o
TEST_BUILTINS_OBJS += test-textil-ext-policy.o
...
LIB_OBJS += tag.o
LIB_OBJS += tempfile.o
LIB_OBJS += textil-ext-executor.o
LIB_OBJS += textil-ext-json.o
LIB_OBJS += textil-ext-policy.o
